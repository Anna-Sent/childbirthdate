...
public final class CorrectedGestationalAge extends GestationalAge {
    ...
    public CorrectedGestationalAge(Calendar start, int menstrualCycleLen, int lutealPhaseLen) {
        super(start);
        int phollicularPhaseLen = menstrualCycleLen - lutealPhaseLen;
        difference = -PregnancyCalculator.AVG_PHOLLICULAR_PHASE_LENGTH + phollicularPhaseLen;
    }
