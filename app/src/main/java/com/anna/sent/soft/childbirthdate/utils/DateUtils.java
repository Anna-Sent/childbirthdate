...
public class DateUtils {
    ...
    public static void init(DatePicker datePicker, DatePicker.OnDateChangedListener listener) {
        Calendar today = Calendar.getInstance();
        init(datePicker, today, listener);
    }

    public static void init(DatePicker datePicker, Calendar date, DatePicker.OnDateChangedListener listener) {
        int year = date.get(Calendar.YEAR),
                monthOfYear = date.get(Calendar.MONTH),
