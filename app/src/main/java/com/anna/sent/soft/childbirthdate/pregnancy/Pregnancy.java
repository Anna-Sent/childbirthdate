...
public abstract class Pregnancy {
     ...
     */
    Pregnancy(int weeks, @IntRange(from = 0, to = 6) int days, Calendar current) {
     ...
     *
     * @return {@code true}, if {@code weeks} and {@code days} values are correct; {@code false}, otherwise
     */
